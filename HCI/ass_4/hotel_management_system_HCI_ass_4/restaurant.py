...
localtime=weekday + " " + day+"/"+month+"/"+year#time.asctime(time.localtime(time.time()))
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Hotel Management System",fg="steel blue",bd=10,anchor='w')
...
status = Label(f2,font=('aria', 15, 'bold'),width = 25, text="-By Jayprakash Chawla, BE4",bd=2,relief=SUNKEN)
